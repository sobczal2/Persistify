...
public class FileSystemLongLinearRepositoryManagerTests
{
    private string _tempDirectoryPath;
    private readonly IOptions<StorageSettings> _storageSettings;
    private readonly ISystemClock _systemClock;
    private readonly FileSystemLongLinearRepositoryManager _sut;

    public FileSystemLongLinearRepositoryManagerTests()
    {
        ...
        _sut = new FileSystemLongLinearRepositoryManager(
            _storageSettings,
            _systemClock
        );
    }
    ...
    public void Ctor_StoreSettingsOptionsIsNull_ThrowsArgumentNullException()
    {
        ...
        // Act
        var action = new Action(() => new FileSystemLongLinearRepositoryManager(
            storageSettings,
            systemClock
        ));
