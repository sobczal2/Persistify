...
public class StreamLongLinearRepositoryTests
{
    private StreamLongLinearRepository _sut;
    private System.IO.Stream _stream;

    public StreamLongLinearRepositoryTests()
    {
        _stream = new MemoryStream();
        _sut = new StreamLongLinearRepository(_stream);
    }
    ...
    public void Ctor_WhenStreamIsNull_ThrowsArgumentNullException()
    {
        ...
        // Act
        var action = new Action(() => new StreamLongLinearRepository(stream));
    ...
    public async Task WriteAsync_WhenIdIsBiggerThanLength_ExtendsStream()
    {
        ...
        // Assert
        _stream.Length.Should().Be((id + 1) * sizeof(long));
    }
