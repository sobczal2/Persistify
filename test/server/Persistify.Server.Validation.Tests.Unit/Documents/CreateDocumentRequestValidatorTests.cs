...
public class CreateDocumentRequestValidatorTests
{
    ...
    private readonly IValidator<DateTimeFieldValueDto> _dateTimeFieldValueValidator;
    ...
    private readonly IValidator<BinaryFieldValueDto> _binaryFieldValueValidator;
    ...
    public CreateDocumentRequestValidatorTests()
    {
        ...
        _dateTimeFieldValueValidator = Substitute.For<IValidator<DateTimeFieldValueDto>>();
        _binaryFieldValueValidator = Substitute.For<IValidator<BinaryFieldValueDto>>();
        ...
        _sut = new CreateDocumentRequestValidator(
            ...
            _dateTimeFieldValueValidator,
            _binaryFieldValueValidator,
            _templateManager
        );
    }
    ...
    [Fact]
    public void Ctor_WhenDateTimeFieldValueValidatorIsNull_ThrowsArgumentNullException()
    {
        // Arrange
    ...
    [Fact]
    public void Ctor_WhenBinaryFieldValueValidatorIsNull_ThrowsArgumentNullException()
    {
        // Arrange
    ...
    public void Ctor_WhenCorrect_SetsPropertyNamesCorrectly()
    {
        ...
        _sut.PropertyName
            .Should()
            .BeEquivalentTo(new List<string> { "CreateDocumentRequest" });
    ...
    public async Task Validate_WhenTemplateDoesNotExist_ReturnsValidationException()
    {
        ...
        var request = new CreateDocumentRequest
        {
            ...
            {
                new TextFieldValueDto { FieldName = "Test", Value = "Test" }
            }
        };
    ...
    public async Task Validate_WhenTextFieldValuesHasOneValue_CallsTextFieldValueValidatorWithCorrectPropertyName()
    {
        ...
        _templateManager
            ...
            .Returns(new Template { Fields = new List<Field>() });
        ...
        propertyNameAtCall
            .Should()
            .BeEquivalentTo(
                new List<string>(new[] { "CreateDocumentRequest", "FieldValueDtos[0]" })
            );
    }
    ...
    public async Task Validate_WhenRequiredNumberFieldIsMissing_ReturnsValidationException()
    {
        ...
        _templateManager
            .GetAsync(request.TemplateName)
            .Returns(
                new Template { Fields = new List<Field> { new NumberField { Name = "2", Required = true } } }
            );
    ...
    public async Task Validate_WhenRequiredBoolFieldIsMissing_ReturnsValidationException()
    {
        ...
        _templateManager
            .GetAsync(request.TemplateName)
            .Returns(
                new Template { Fields = new List<Field> { new BoolField { Name = "2", Required = true } } }
            );
    ...
    public async Task Validate_WhenNotRequiredNumberFieldIsMissing_ReturnsOk()
    {
        ...
        _templateManager
            .GetAsync(request.TemplateName)
            .Returns(
                new Template { Fields = new List<Field> { new NumberField { Name = "2", Required = false } } }
            );
    ...
    public async Task Validate_WhenNotRequiredBoolFieldIsMissing_ReturnsOk()
    {
        ...
        _templateManager
            .GetAsync(request.TemplateName)
            .Returns(
                new Template { Fields = new List<Field> { new BoolField { Name = "2", Required = false } } }
            );
