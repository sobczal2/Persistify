...
public class FullTextSearchQueryDtoBuilder<TDocument> : FieldSearchQueryDtoBuilder<TDocument, FullTextSearchQueryDtoBuilder<TDocument>>
    where TDocument : class
{
    public FullTextSearchQueryDtoBuilder(IPersistifyHighLevelClient persistifyHighLevelClient) : base(persistifyHighLevelClient)
    {
