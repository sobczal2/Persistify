    ...
    where TDocument : class
{
    ...
    public AndSearchQueryBuilder<TDocument> AddQuery(
    ...
    )
    {
        ...
        ((AndSearchQueryDto)SearchQueryDto!).SearchQueryDtos.Add(
    ...
    public AndSearchQueryBuilder<TDocument> WithBoost(
        float boost
    )
    {
