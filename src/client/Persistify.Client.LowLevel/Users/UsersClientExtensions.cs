...
public static class UsersClientExtensions
{
        ...
        CallContext? callContext = default)
    {
        ...
        return await persistifyLowLevelClient.Users.SignInAsync(userService, signInRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.RefreshTokenAsync(userService, refreshTokenRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.CreateUserAsync(userService, createUserRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.GetUserAsync(userService, getUserRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.SetPermissionAsync(userService, setPermissionRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.DeleteUserAsync(userService, deleteUserRequest, callContext);
    }
    ...
    {
        var userService = persistifyLowLevelClient.Users.GetService();
        return await persistifyLowLevelClient.Users.ChangeUserPasswordAsync(userService, changeUserPasswordRequest,
            callContext);
    }
}
