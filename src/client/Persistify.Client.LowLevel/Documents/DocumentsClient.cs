...
public class DocumentsClient : SubClient<IDocumentService>, IDocumentsClient
{
    ...
    )
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<CreateDocumentResponse>(
            async cc =>
                await Result<CreateDocumentResponse>.FromAsync(
                    async () => await documentService.CreateDocumentAsync(createDocumentRequest, cc)
                ),
            callContext
        );
    }

    public async Task<Result<GetDocumentResponse>> GetDocumentAsync(
        IDocumentService documentService,
    ...
    )
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<GetDocumentResponse>(
            async cc =>
                await Result<GetDocumentResponse>.FromAsync(
                    async () => await documentService.GetDocumentAsync(getDocumentRequest, cc)
                ),
            callContext
        );
    }

    public async Task<Result<SearchDocumentsResponse>> SearchDocumentsAsync(
        IDocumentService documentService,
    ...
    )
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<SearchDocumentsResponse>(
            async cc =>
                await Result<SearchDocumentsResponse>.FromAsync(
                    async () =>
                        await documentService.SearchDocumentsAsync(searchDocumentsRequest, cc)
                ),
            callContext
        );
    }

    public async Task<Result<DeleteDocumentResponse>> DeleteDocumentAsync(
        IDocumentService documentService,
    ...
    )
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<DeleteDocumentResponse>(
            async cc =>
                await Result<DeleteDocumentResponse>.FromAsync(
                    async () => await documentService.DeleteDocumentAsync(deleteDocumentRequest, cc)
                ),
            callContext
        );
    }

    public async Task<Result<ExistsDocumentResponse>> ExistsDocumentAsync(
        IDocumentService documentService,
    ...
    )
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<ExistsDocumentResponse>(
            async cc =>
                await Result<ExistsDocumentResponse>.FromAsync(
                    async () => await documentService.ExistsDocumentAsync(existsDocumentRequest, cc)
                ),
            callContext
        );
    }
