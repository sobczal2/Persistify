...
{
    internal PresetAnalyzersClient(PersistifyLowLevelClient persistifyLowLevelClient) : base(persistifyLowLevelClient)
    {
    }
        ...
        CreatePresetAnalyzerRequest createPresetAnalyzerRequest, CallContext? callContext = default)
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<CreatePresetAnalyzerResponse>(
            async cc => await Result<CreatePresetAnalyzerResponse>.FromAsync(async () =>
                await presetAnalyzerService.CreatePresetAnalyzerAsync(createPresetAnalyzerRequest, cc)),
            callContext
        );
    }
        ...
        GetPresetAnalyzerRequest getPresetAnalyzerRequest, CallContext? callContext = default)
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<GetPresetAnalyzerResponse>(
            async cc => await Result<GetPresetAnalyzerResponse>.FromAsync(async () =>
                await presetAnalyzerService.GetPresetAnalyzerAsync(getPresetAnalyzerRequest, cc)),
            callContext
        );
    }
        ...
        ListPresetAnalyzersRequest listPresetAnalyzersRequest, CallContext? callContext = default)
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<ListPresetAnalyzersResponse>(
            async cc => await Result<ListPresetAnalyzersResponse>.FromAsync(async () =>
                await presetAnalyzerService.ListPresetAnalyzersAsync(listPresetAnalyzersRequest, cc)),
            callContext
        );
    }
        ...
        DeletePresetAnalyzerRequest deletePresetAnalyzerRequest, CallContext? callContext = default)
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<DeletePresetAnalyzerResponse>(
            async cc => await Result<DeletePresetAnalyzerResponse>.FromAsync(async () =>
                await presetAnalyzerService.DeletePresetAnalyzerAsync(deletePresetAnalyzerRequest, cc)),
            callContext
        );
    }
        ...
        ExistsPresetAnalyzerRequest existsPresetAnalyzerRequest, CallContext? callContext = default)
    {
        return await PersistifyLowLevelClient.CallAuthenticatedServiceAsync<ExistsPresetAnalyzerResponse>(
            async cc => await Result<ExistsPresetAnalyzerResponse>.FromAsync(async () =>
                await presetAnalyzerService.ExistsPresetAnalyzerAsync(existsPresetAnalyzerRequest, cc)),
            callContext
        );
    }
}
