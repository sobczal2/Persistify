...
public static class PresetAnalyzersClientExtensions
{
        ...
        CallContext? callContext = default)
    {
        ...
        return await persistifyLowLevelClient.PresetAnalyzers.CreatePresetAnalyzerAsync(presetAnalyzerService,
            createPresetAnalyzerRequest, callContext);
    }
    ...
    {
        var presetAnalyzerService = persistifyLowLevelClient.PresetAnalyzers.GetService();
        return await persistifyLowLevelClient.PresetAnalyzers.GetPresetAnalyzerAsync(presetAnalyzerService,
            getPresetAnalyzerRequest, callContext);
    }
    ...
    {
        var presetAnalyzerService = persistifyLowLevelClient.PresetAnalyzers.GetService();
        return await persistifyLowLevelClient.PresetAnalyzers.ListPresetAnalyzersAsync(presetAnalyzerService,
            listPresetAnalyzersRequest, callContext);
    }
    ...
    {
        var presetAnalyzerService = persistifyLowLevelClient.PresetAnalyzers.GetService();
        return await persistifyLowLevelClient.PresetAnalyzers.DeletePresetAnalyzerAsync(presetAnalyzerService,
            deletePresetAnalyzerRequest, callContext);
    }
    ...
    {
        var presetAnalyzerService = persistifyLowLevelClient.PresetAnalyzers.GetService();
        return await persistifyLowLevelClient.PresetAnalyzers.ExistsPresetAnalyzerAsync(presetAnalyzerService,
            existsPresetAnalyzerRequest, callContext);
    }
}
