...
public interface IPresetAnalyzersClient
{
    ...
    Task<CreatePresetAnalyzerResponse> CreatePresetAnalyzerAsync(
        IPresetAnalyzerService presetAnalyzerService,
        CreatePresetAnalyzerRequest createPresetAnalyzerRequest,
        CallContext? callContext = default
    );

    Task<GetPresetAnalyzerResponse> GetPresetAnalyzerAsync(
        IPresetAnalyzerService presetAnalyzerService,
        GetPresetAnalyzerRequest getPresetAnalyzerRequest,
        CallContext? callContext = default
    );

    Task<ListPresetAnalyzersResponse> ListPresetAnalyzersAsync(
        IPresetAnalyzerService presetAnalyzerService,
        ListPresetAnalyzersRequest listPresetAnalyzersRequest,
        CallContext? callContext = default
    );

    Task<DeletePresetAnalyzerResponse> DeletePresetAnalyzerAsync(
        IPresetAnalyzerService presetAnalyzerService,
        DeletePresetAnalyzerRequest deletePresetAnalyzerRequest,
        CallContext? callContext = default
    );

    Task<ExistsPresetAnalyzerResponse> ExistsPresetAnalyzerAsync(
        IPresetAnalyzerService presetAnalyzerService,
