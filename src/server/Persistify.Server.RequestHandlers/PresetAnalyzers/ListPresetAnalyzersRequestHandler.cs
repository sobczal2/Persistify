...
public class ListPresetAnalyzersRequestHandler
    : RequestHandler<ListPresetAnalyzersRequest, ListPresetAnalyzersResponse>
{
    ...
    )
    {
        ...
        _presetAnalyzers = await _presetAnalyzerManager
            .ListAsync(take, skip)
    ...
    protected override ListPresetAnalyzersResponse GetResponse()
    {
        var presetAnalyzers =
            _presetAnalyzers
            ?? throw new InternalPersistifyException(nameof(ListPresetAnalyzersRequest));
