...
public class DocumentManagerFileGroupForTemplate : IFileGroupForTemplate
{
    ...
    public IEnumerable<string> GetFileNamesForTemplate(
        Template template
    )
    {
    ...
    public static string IdentifierFileName(
        int templateId
    )
    {
    ...
    public static string DocumentRepositoryMainFileName(
        int templateId
    )
    {
    ...
    public static string DocumentRepositoryOffsetLengthFileName(
        int templateId
    )
    {
