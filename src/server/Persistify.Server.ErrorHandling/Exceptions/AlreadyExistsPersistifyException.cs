...
{
    public AlreadyExistsPersistifyException(string? requestName = null, string message = "Not found") : base(
        requestName ?? "Unknown", message, PersistifyErrorCode.AlreadyExists)
    {
    }
}
