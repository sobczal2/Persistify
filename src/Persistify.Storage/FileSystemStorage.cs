...
public class FileSystemStorage : IStorage
{
    ...
    public FileSystemStorage(string rootPath, Func<Stream, Stream>? compress = null,
    ...
    public async ValueTask SaveBlobAsync(string key, string data, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<string> LoadBlobAsync(string key, CancellationToken cancellationToken = default)
    {
