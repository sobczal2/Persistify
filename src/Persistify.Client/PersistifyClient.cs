...
public class PersistifyClient : IPersistifyClient
{
    ...
    public async IAsyncEnumerable<PipelineEventProto> PipelineStreamAsync(
    ...
    public async Task<PipelineInfosResponseProto> PipelineInfosAsync(
    ...
    )
    {
        ...
        return await client.PipelineInfosAsync(
            new EmptyProto(),
