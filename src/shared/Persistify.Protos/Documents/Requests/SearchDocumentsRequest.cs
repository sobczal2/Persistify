...
public class SearchDocumentsRequest
{
    ...
    [DataMember(Order = 4)]
    public NotOperator? NotOperator { get; set; }

    [DataMember(Order = 5)]
    public FtsQuery? FtsOperator { get; set; }

    [DataMember(Order = 6)]
    public NumberQuery? NumberOperator { get; set; }

    [DataMember(Order = 7)]
    public BoolQuery? BoolOperator { get; set; }
